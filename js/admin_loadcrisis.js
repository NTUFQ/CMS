  ...
  query.find().then(
    function(crisislist) {
      ...
      for (i = 0; i < crisislist.length; i++) {
        ...
        var inhtml = `<div class='well' id="i">
                ...
                <div class = "row">
                  <a href = "admin_editcrisis.html" ><button type = "button" id = "editcrisis" onclick = "saveid_cookie(`+i+`)" name = "admin_editcrisis" class="btn btn-primary btn-md"> Edit Crisis</button></a>
                  <a href = "admin_editcrisis.html" ><button type = "button" id = "deletecrisis" name = "admin_delete_crisis" class="btn btn-primary btn-md"> Delete Crisis</button></a>
                </div>
              </div>`;
